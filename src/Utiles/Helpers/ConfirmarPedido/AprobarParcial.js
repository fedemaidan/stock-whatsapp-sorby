...
const { editMovimientoToSheetWithClientGeneral, addMovimientoToSheetWithClientGeneral } = require('../../GoogleServices/Sheets/movimiento');
const { editPedidoToSheetWithClientGeneral, addPedidoToSheetWithClientGeneral } = require('../../GoogleServices/Sheets/pedido');
...
module.exports = async function AprobarParcial(userId) {
    try {
        ...
        await editPedidoToSheetWithClientGeneral(pedidoActualizado, { sheetWithClient: '1Nd4_14gz03AXg8dJUY6KaZEynhoc5Eaq-EAVqcLh3ek' });
        ...
        for (const mov of aprobados) {
            ...
            await editMovimientoToSheetWithClientGeneral(movActualizado, { sheetWithClient: '1Nd4_14gz03AXg8dJUY6KaZEynhoc5Eaq-EAVqcLh3ek' });
        }
        ...
        for (const mov of rechazados) {
            ...
            await addMovimientoToSheetWithClientGeneral(nuevoMov, { sheetWithClient: '1Nd4_14gz03AXg8dJUY6KaZEynhoc5Eaq-EAVqcLh3ek' });
            ...
            await addMovimientoToSheetWithClientGeneral(devolucion, { sheetWithClient: '1Nd4_14gz03AXg8dJUY6KaZEynhoc5Eaq-EAVqcLh3ek' });
        }
